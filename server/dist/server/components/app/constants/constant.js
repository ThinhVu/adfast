...
module.exports = (0, _freeze2.default)({
	...
	success: {
		...
		send_email_success: 'Đăng ký tài khoản thành công. Vui lòng kiểm tra hộp thư đên trong email đăng ký để kích' + ' hoạt tài khoản, (bạn có thể kiểm tra thêm trong hòm thư Spam nếu không thấy email kích hoạt)!',
	...
	warning: {
		...
		user_lock_one_minutes: 'Tài khoản hiện đang bị khóa trong 1 phút. Vui lòng thử lại sau 1 phút hoặc liên hệ' + ' AdFast để kích hoạt lại tài khoản trong thời gian sớm nhất',
		user_lock_remain_time: 'Tài khoản hiện đang bị khóa trong {0} phút. Vui lòng thử lại sau {1} phút hoặc' + ' liên hệ AdFast để kích hoạt lại tài khoản trong thời gian sớm nhất',
		user_lock_exceeds_limit: 'Đăng nhập quá số lần cho phép, tài khoản của bạn bị khóa trong thời gian 30 phút! Vui' + ' lòng liên hệ AdFast để kích hoạt lại tài khoản sớm nhất!',
		user_not_active: 'Tài khoản chưa được kích hoạt, Vui lòng kiểm tra mail đăng ký để kích hoạt hoặc liên hệ AdFast' + ' để kích hoạt tài khoản sớm nhất!',
	...
	package: {
		...
		error: {
			...
			user_not_register_package: 'Bạn hiện chưa đăng ký sử dụng gói dịch vụ nào! Vui lòng liên hệ bộ phận hỗ trợ ' + 'để mua gói dịch vụ!',
			not_find_package: 'Không tìm thấy gói sử dụng cho tài khoản này!'
		},
		success: {
			register_plan_success: "\u0110\u0103ng k\xFD mua g\xF3i {0} th\xE0nh c\xF4ng!",
